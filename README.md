...
```
cd existing_repo
git remote add origin https://gitlab.hs-ruhrwest.de/knshmahe/webtec-sose-23.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.hs-ruhrwest.de/knshmahe/webtec-sose-23/-/settings/integrations)
